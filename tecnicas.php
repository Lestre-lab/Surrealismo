...
<section class="t">
 ...
 <div class="seccion-texto-tec">
<h2 class="seccion-titulo">Técnicas</h2><br>
      <h2 class="seccion-titulo">Aerografía</h2>

<p><b><i>La aerografía, más conocida cómo graffiti, es una técnica en donde un objeto tridimensional es utilizado para hacer un esténcil aplicando spray.</i></b></p>
...
<p>La continua experimentación llevó al artista a desarrollar una nueva técnica llamada “grattage”, en la cual un lienzo preparado con una o varias capas de pintura era colocado sobre una superficie con relieve y luego raspado, desprendiendo la pintura para obtener un relieve del objeto.
       ...
       <div class="seccion-texto-tec">
      <h2 class="seccion-titulo">Frottage</h2>

<b><i><p>En arte, el frottage (de frotter francés, «frotar», frotar) es un método surrealista y «automático» de producción creativa desarrollado por Max Ernst.</p></i></b>

<p>Esta técnica se basa en la reproducción de la textura de diferentes objetos con resultados en muchos casos sorprendentes en papel; por ejemplo: una moneda, una hoja de árbol seca, etcétera; frotar con una barra de color, un lápiz de grafito o de color, con ceras u otros materiales que permitan atrapar la textura en la hoja de papel.</p>
<p>
